...
SQL is a language used to find things in a database.
A Relational Database is a database that links things in relation to one another.

- [x] Why do tables need a `primary key`?

tales need to have a primary key so that each entry can be 'IDed' and then found by ID
